...
import org.spacehq.mc.protocol1_8.packet.ingame.client.ClientPluginMessagePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.ClientRequestPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.ClientResourcePackStatusPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.ClientSettingsPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.ClientTabCompletePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientChangeHeldItemPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerAbilitiesPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerActionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerInteractEntityPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerMovementPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerPlaceBlockPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerPositionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerPositionRotationPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerRotationPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientPlayerStatePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientSpectatePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientSteerVehiclePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.player.ClientSwingArmPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.window.ClientCloseWindowPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.window.ClientConfirmTransactionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.window.ClientCreativeInventoryActionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.window.ClientEnchantItemPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.window.ClientWindowActionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.client.world.ClientUpdateSignPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerChatPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerCombatPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerDifficultyPacket;
...
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerPluginMessagePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerResourcePackSendPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerRespawnPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerSetCompressionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerStatisticsPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerSwitchCameraPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerTabCompletePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.ServerTitlePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerAnimationPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerCollectItemPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerDestroyEntitiesPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityAttachPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityEffectPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityEquipmentPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityHeadLookPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityMetadataPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityMovementPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityNBTUpdatePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityPositionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityPositionRotationPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityPropertiesPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityRemoveEffectPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityRotationPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityStatusPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityTeleportPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.ServerEntityVelocityPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.player.ServerChangeHeldItemPacket;
...
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.player.ServerPlayerUseBedPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.player.ServerSetExperiencePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.player.ServerUpdateHealthPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.spawn.ServerSpawnExpOrbPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.spawn.ServerSpawnGlobalEntityPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.spawn.ServerSpawnMobPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.spawn.ServerSpawnObjectPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.spawn.ServerSpawnPaintingPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.entity.spawn.ServerSpawnPlayerPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.scoreboard.ServerDisplayScoreboardPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.scoreboard.ServerScoreboardObjectivePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.scoreboard.ServerTeamPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.scoreboard.ServerUpdateScorePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.window.ServerCloseWindowPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.window.ServerConfirmTransactionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.window.ServerOpenWindowPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.window.ServerSetSlotPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.window.ServerWindowItemsPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.window.ServerWindowPropertyPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerBlockBreakAnimPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerBlockChangePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerBlockValuePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerChunkDataPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerExplosionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerMapDataPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerMultiBlockChangePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerMultiChunkDataPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerNotifyClientPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerOpenTileEntityEditorPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerPlayEffectPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerPlaySoundPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerSpawnParticlePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerSpawnPositionPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerUpdateSignPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerUpdateTileEntityPacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerUpdateTimePacket;
import org.spacehq.mc.protocol1_8.packet.ingame.server.world.ServerWorldBorderPacket;
...
public class MinecraftProtocol_18 extends PacketProtocol implements MinecraftProtocol {
    ...
    private MinecraftProtocol_18() {
    }
    
    public MinecraftProtocol_18(final ProtocolMode mode) {
    ...
    public MinecraftProtocol_18(final String username) {
        this(ProtocolMode.LOGIN);
        this.profile = new GameProfile((UUID) null, username);
    }
    
    public MinecraftProtocol_18(final String username, final String using,
    ...
    public MinecraftProtocol_18(final GameProfile profile, final String accessToken) {
        this(ProtocolMode.LOGIN);
